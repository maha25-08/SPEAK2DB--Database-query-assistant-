...
from routes.voice_routes import register_voice_routes
from routes.views import views_bp
from utils.helpers import is_staff
from utils.settings_helper import _get_setting, _get_bool_setting, _get_int_setting, _set_setting
...
# Register new modular admin blueprints
from routes.admin_user_routes import register_admin_user_routes
from routes.admin_roles_routes import register_admin_roles_routes
from routes.admin_logs_routes import register_admin_logs_routes
from routes.admin_settings_routes import register_admin_settings_routes
from routes.admin_security_routes import register_admin_security_routes
...
if __name__ == "__main__":
    ...
    # Seed fake data for demo purposes
    from admin_data_functions import seed_fake_activity, seed_fake_security
    
    print("Seeding fake demo data...")
    seed_fake_activity()
    seed_fake_security()
